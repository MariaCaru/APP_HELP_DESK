...
//percorrer o arquivo enquanto houver registros/linhas a serem recuperados
while(!feof($arquivo)) { //tsta pelo fim do arquivo
  //linhas
   ...
   if($_SESSION['perfil_id'] == 2) {
    ...
    if($_SESSION['id'] != $registro_detalhes[0]) {
      continue;//não faz nada
       ...
       //adiciona o registro do arquivo ao array $chamados
       $chamado = array (
        'id' => $registro_detalhes[0],
        'titulo' => $registro_detalhes[1],
        'categoria' => $registro_detalhes[2],
        'descricao' => $registro_detalhes[3],
       );
